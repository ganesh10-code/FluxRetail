...
Uses SQLAlchemy async engine so migrations run correctly against asyncpg.
DATABASE_URL env var overrides the alembic.ini value at runtime.
"""
...
from models.metric import MetricModel  # noqa: F401
from models.session import SessionModel  # noqa: F401
...
def run_migrations_offline() -> None:
    ...
    Generates SQL scripts without an actual DB connection.
    """
